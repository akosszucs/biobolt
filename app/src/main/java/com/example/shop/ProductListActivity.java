...
public class ProductListActivity extends AppCompatActivity {
    ...
    public void deleteItem(Product item) {
        ...
        ref.delete()
            .addOnSuccessListener(success -> {
                Log.d(LOG_TAG, "Az termék törlése sikeres: " + item._getId());
            })
            .addOnFailureListener(fail -> {
                Toast.makeText(this, "Ezt a terméket " + item._getId() + " nem lehet törölni.", Toast.LENGTH_LONG).show();
            });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.settings_button:
                ...
                return true;
            case R.id.cart:
                Log.d(LOG_TAG, "Bevásárlókocsi megnyomva!");
                return true;
    ...
    public void updateAlertIcon(Product item) {
        ...
        mItems.document(item._getId()).update("cartedCount", item.getCartedCount() + 1)
            .addOnFailureListener(fail -> {
                Toast.makeText(this, "A terméket " + item._getId() + " nem lehet megváltoztatni.", Toast.LENGTH_LONG).show();
            });
